...
public class Car {
    ...
    public static JSONArray listToJsonArray(List<org.example.practiceproblems.javaobjecttoJSONarray.Car> carList){
        // Creating the JSON Array
        JSONArray carDetails = new JSONArray();

        // Iterating over all the Java car objects in the list
        for(org.example.practiceproblems.javaobjecttoJSONarray.Car car : carList){
